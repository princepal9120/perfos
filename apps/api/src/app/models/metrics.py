...
class Spend(Base):
    ...
    ad_account_id: Mapped[Optional[int]] = mapped_column(
...
class Revenue(Base):
    ...
    __table_args__ = (
        CheckConstraint("source IN ('shopify','stripe')", name="ck_revenue_source"),
    )
    ...
    customer_id: Mapped[Optional[str]] = mapped_column(String(255), default=None)
