    ...
    <>
        ...
        <button
          ...
          className={cn(
            ...
            isOpen
              ...
              : "bg-gradient-to-tr from-purple-600 to-indigo-500 text-white hover:from-purple-500 hover:to-indigo-400 hover:scale-105"
          )}
        >
          {isOpen ? (
      ...
      {isOpen && (
        <div className="fixed bottom-20 right-6 z-50 flex h-[480px] w-88 max-w-[calc(100vw-2rem)] sm:w-96 flex-col overflow-hidden rounded-2xl border border-white/10 bg-[#12131a] shadow-2xl shadow-purple-950/60 animate-in slide-in-from-bottom-5 duration-200">
          {/* Header */}
          <div className="flex items-center justify-between border-b border-white/[0.08] bg-[#161722] px-4 py-3">
          ...
          <div className="flex-1 space-y-3 overflow-y-auto p-4 text-xs">
                ...
                <div
                  className={cn(
                    ...
                    m.role === "user"
                      ...
                      : "border border-white/[0.06] bg-[#1a1b26] text-zinc-200"
                  )}
                >
                  {m.text}
                </div>
            ...
            {loading && (
              <div className="flex justify-start">
                <div className="rounded-xl border border-white/[0.06] bg-[#1a1b26] px-3 py-2 text-zinc-400">
          ...
          {/* Quick Prompts */}
          <div className="flex gap-1.5 overflow-x-auto border-t border-white/[0.06] bg-[#14151e] p-2">
            {[
              ...
              <button
                ...
                className="shrink-0 rounded-full border border-white/[0.08] bg-[#1a1b24] px-2.5 py-1 text-[10px] text-zinc-300 transition-colors hover:border-purple-500/40 hover:bg-purple-950/30 hover:text-purple-300"
              >
                {prompt}
              </button>
            ))}
          ...
          <form
            ...
            className="flex items-center gap-2 border-t border-white/[0.08] bg-[#12131a] p-3"
          >
            <input
              type="text"
              value={input}
