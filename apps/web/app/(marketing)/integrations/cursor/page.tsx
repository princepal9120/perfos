    ...
    <div className="py-16 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
      ...
      <div className="p-6 rounded-2xl bg-[#111218] border border-white/10 space-y-4">
        ...
        <p className="text-xs text-zinc-400">
          Go to Cursor Settings &gt; Features &gt; MCP &gt; Add New MCP Server. Choose type <code className="text-zinc-200">command</code> and enter <code className="text-zinc-200">npx -y @adkit/mcp-server</code>.
        </p>
      </div>
      ...
      <div className="text-center pt-4">
        <Link
          href="/pricing"
          className="px-8 py-3.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-semibold shadow-lg shadow-indigo-600/30 transition-all"
        >
