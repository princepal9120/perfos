...
export default function ClaudeGoogleadsPage() {
  ...
  const prompt = "Analyze our active Google Ads & YouTube campaigns. Find the 3 highest spending ad sets from the past 14 days, report their CTR and ROAS, and recommend creative variations from our top competitor swipe file.";
