    ...
    <div className="py-16 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
      <div className="space-y-4 text-center">
        ...
        <h1 className="text-4xl font-display font-bold text-foreground dark:text-white tracking-tight">
          Manage Google Ads & YouTube with Claude
        </h1>
        <p className="text-muted-foreground text-sm sm:text-base max-w-2xl mx-auto">
          Equip Claude with direct, typed tools to query metrics, spy on
          competitor Google Ads & YouTube creatives, and push fresh variants on
          autopilot.
        </p>
      </div>
      ...
      <div className="p-6 rounded-2xl bg-card border border-border space-y-4">
        ...
        <p className="p-4 rounded-xl bg-black/60 font-mono text-xs text-foreground">
          &quot;Analyze our active Google Ads & YouTube campaigns. Find the 3
          highest spending ad sets from the past 14 days, report their CTR and
          ROAS, and recommend creative variations from our top competitor swipe
          file.&quot;
        </p>
      </div>
      ...
      <div className="text-center pt-4">
        ...
        >
          Connect Claude to Google Ads & YouTube →
        </Link>
      </div>
    </div>
  );
