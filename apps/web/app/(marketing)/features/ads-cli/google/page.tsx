...
export default function GoogleAdsCliPage() {
  ...
  const cmd = "perfos google deploy --campaign 'Growth Q3' --budget 250";
    ...
    <div className="py-16 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16 text-foreground">
      <div className="space-y-4 text-center">
        ...
        <div className="flex items-center justify-center gap-3">
          ...
          <h1 className="text-4xl sm:text-5xl font-extrabold text-white tracking-tight">
            Google Ads CLI for Developers &amp; Agents
          </h1>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-xs">
        ...
        <div className="p-5 rounded-xl bg-surface border border-border space-y-2">
          ...
          <p className="text-zinc-400 leading-relaxed">
            Built-in exponential backoff and token caching for Google &amp; YouTube Ads API endpoints.
          </p>
        </div>
        <div className="p-5 rounded-xl bg-surface border border-border space-y-2">
          <h3 className="font-bold text-white text-sm">
