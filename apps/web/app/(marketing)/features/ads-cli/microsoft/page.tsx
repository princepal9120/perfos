    ...
    <div className="py-16 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
      <div className="space-y-4 text-center">
        ...
        <p className="text-muted-foreground text-sm sm:text-base max-w-2xl mx-auto">
          Query live metrics, pause underperforming ad sets, and push creative
          updates to Microsoft Advertising straight from your terminal or CI/CD
          jobs.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-xs">
        <div className="p-5 rounded-xl bg-card border border-border space-y-2">
          ...
          <p className="text-muted-foreground">
            Trigger ad set updates automatically when new landing page variants
            merge to production.
          </p>
        </div>
        <div className="p-5 rounded-xl bg-card border border-border space-y-2">
          ...
          <p className="text-muted-foreground">
            Built-in exponential backoff and token caching for Microsoft
        ...
        <div className="p-5 rounded-xl bg-card border border-border space-y-2">
          ...
          <p className="text-muted-foreground">
            Hard ceilings on maximum daily spend changes so AI agents never
            overspend.
          </p>
        </div>
      </div>
