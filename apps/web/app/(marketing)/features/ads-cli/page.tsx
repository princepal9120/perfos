    ...
    <div className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-20">
      <div className="text-center max-w-3xl mx-auto space-y-5">
        ...
        <div className="flex justify-center gap-4 pt-2">
          <button
            onClick={handleCopy}
            className="px-6 py-3 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-semibold shadow-lg shadow-emerald-600/30 transition-all font-mono"
          >
      ...
      <div className="max-w-3xl mx-auto rounded-2xl bg-[#0e0f14] border border-white/10 p-4 font-mono text-xs shadow-2xl space-y-3">
        <div className="flex items-center gap-2 border-b border-white/6 pb-2 text-zinc-500">
        ...
        <div className="text-zinc-300 space-y-2">
          ...
          <p className="text-zinc-500">→ Discovered 14 evergreen ads running &gt; 90 days on Meta &amp; LinkedIn.</p>
          <p><span className="text-emerald-400">$</span> adkit clone --ad-id 489201 --remix --brand-kit perfos.json</p>
          <p className="text-zinc-500">✓ Synthesized 10 on-brand creative variants into ./staged-creatives/</p>
