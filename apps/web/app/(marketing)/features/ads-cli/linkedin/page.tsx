...
export default function LinkedInAdsCliPage() {
  ...
  const cmd = "perfos linkedin deploy --campaign 'B2B Q3' --budget 300";
    ...
    <div className="py-16 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16 text-foreground">
      <div className="space-y-4 text-center">
        ...
        <p className="text-zinc-400 text-sm sm:text-base max-w-2xl mx-auto leading-relaxed">
          B2B title targeting, lead gen form optimization, and company audience segmentation directly from your terminal.
        </p>
      </div>
