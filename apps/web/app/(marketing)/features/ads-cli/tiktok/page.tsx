...
export default function TikTokAdsCliPage() {
  ...
  const cmd = "perfos tiktok deploy --campaign 'Spark Q3' --budget 250";
      ...
      <div className="space-y-4 text-center">
        ...
        <div className="flex items-center justify-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-primary/20 border border-primary/30 text-primary">
            <TikTokLogo className="w-5 h-5 text-primary" />
          </div>
        ...
        <p className="text-zinc-400 text-sm sm:text-base max-w-2xl mx-auto leading-relaxed">
          Query live metrics, inspect 3s hook completion rates, and push video variations to TikTok Ads straight from your terminal.
        </p>
      </div>
