...
export default function MetaAdsCliPage() {
  ...
  const cmd = "adkit meta deploy --campaign 'Growth Q3' --budget 250";
    ...
    <div className="py-16 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
      <div className="space-y-4 text-center">
        ...
        <h1 className="text-4xl sm:text-5xl font-display font-bold text-white tracking-tight">
          Meta (Facebook & Instagram) CLI for Developers &amp; Agents
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-xs">
        ...
        <div className="p-5 rounded-xl bg-[#111218] border border-white/10 space-y-2">
          ...
          <p className="text-zinc-400">Built-in exponential backoff and token caching for Meta (Facebook & Instagram) API endpoints.</p>
        </div>
        <div className="p-5 rounded-xl bg-[#111218] border border-white/10 space-y-2">
