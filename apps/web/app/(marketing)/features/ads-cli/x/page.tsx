...
export default function XAdsCliPage() {
  ...
  const cmd = "adkit x deploy --campaign 'Growth Q3' --budget 250";
    ...
    <div className="py-16 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
      <div className="space-y-4 text-center">
        ...
        <p className="text-zinc-400 text-sm sm:text-base max-w-2xl mx-auto">
          Query live metrics, pause underperforming ad sets, and push creative updates to X (Twitter) Ads straight from your terminal or CI/CD jobs.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-xs">
        ...
        <div className="p-5 rounded-xl bg-[#111218] border border-white/10 space-y-2">
          ...
          <p className="text-zinc-400">Built-in exponential backoff and token caching for X (Twitter) Ads API endpoints.</p>
        </div>
        <div className="p-5 rounded-xl bg-[#111218] border border-white/10 space-y-2">
