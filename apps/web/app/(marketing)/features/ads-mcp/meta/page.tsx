      ...
      <div className="p-6 rounded-2xl bg-card border border-border space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs font-mono">
          <div className="p-3 rounded-lg bg-black/40 border border-border space-y-1">
            ...
            <p className="text-muted-foreground font-sans text-[11px]">List active, paused, and archived campaigns with live spend & ROAS.</p>
          </div>
          <div className="p-3 rounded-lg bg-black/40 border border-border space-y-1">
            <span className="text-blue-400 font-bold">adkit_meta_update_budget</span>
            <p className="text-muted-foreground font-sans text-[11px]">Safely reallocate budget between ad sets with policy bounds.</p>
          </div>
          <div className="p-3 rounded-lg bg-black/40 border border-border space-y-1">
            <span className="text-blue-400 font-bold">adkit_meta_spy_competitor</span>
            <p className="text-muted-foreground font-sans text-[11px]">Query active competitor ad history and creative duration.</p>
          </div>
          <div className="p-3 rounded-lg bg-black/40 border border-border space-y-1">
            <span className="text-blue-400 font-bold">adkit_meta_create_variant</span>
            <p className="text-muted-foreground font-sans text-[11px]">Draft and stage new creative hooks for manual or auto approval.</p>
          </div>
        </div>
      </div>
