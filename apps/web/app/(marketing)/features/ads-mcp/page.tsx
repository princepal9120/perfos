    ...
    <div className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-20">
      <div className="text-center max-w-3xl mx-auto space-y-5">
        ...
        <div className="flex justify-center gap-4 pt-2">
          <Link
            href="/pricing"
            className="px-6 py-3 rounded-xl bg-primary hover:bg-primary text-white dark:text-white text-xs font-semibold shadow-lg shadow-primary/30 transition-all"
          >
      ...
      <div className="space-y-6">
        <div className="text-center">
          <h2 className="text-2xl sm:text-3xl font-display font-bold text-foreground dark:text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {PLATFORMS.map((plat, i) => (
            <div
              key={i}
              className="p-6 rounded-2xl bg-card border border-border hover:border-purple-500/40 transition-all flex flex-col justify-between space-y-4 group"
            >
              ...
              <Link
                ...
                className="text-xs font-semibold text-primary group-hover:text-primary flex items-center gap-1"
              >
