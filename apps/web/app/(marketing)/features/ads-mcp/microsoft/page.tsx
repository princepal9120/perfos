  ...
  return (
    <div className="py-16 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
      ...
      <div className="text-center pt-4">
        <Link
          href="/pricing"
          className="px-8 py-3.5 rounded-xl bg-cyan-600 hover:bg-cyan-500 text-foreground dark:text-white text-xs font-semibold shadow-lg shadow-cyan-600/30 transition-all"
        >
