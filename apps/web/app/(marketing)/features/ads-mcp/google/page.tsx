  ...
  return (
    <div className="py-16 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
      ...
      <div className="p-6 rounded-2xl bg-[#111218] border border-white/10 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs font-mono">
          <div className="p-3 rounded-lg bg-black/40 border border-white/6 space-y-1">
            ...
            <p className="text-zinc-400 font-sans text-[11px]">Fetch Search & PMax campaign metrics, keywords, and search queries.</p>
          </div>
          <div className="p-3 rounded-lg bg-black/40 border border-white/6 space-y-1">
            <span className="text-amber-400 font-bold">adkit_google_add_negative_keywords</span>
            <p className="text-zinc-400 font-sans text-[11px]">Automate search term waste reduction in real-time.</p>
          </div>
        </div>
      </div>
      ...
      <div className="text-center pt-4">
        <Link
          href="/pricing"
          className="px-8 py-3.5 rounded-xl bg-amber-600 hover:bg-amber-500 text-white text-xs font-semibold shadow-lg shadow-amber-600/30 transition-all"
        >
