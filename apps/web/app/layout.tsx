...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    creator: '@adkit_so',
    images: [
      'https://adkit.so/cdn-cgi/image/w=1200,h=630,f=webp,q=90/images/landings/landing-hero.png',
    ],
  },
  alternates: {
    ...
    '@graph': [
      {
        ...
        description:
          'The ads toolbox for marketers & AI agents. Research competitor ads, create on-brand variants, and deploy campaigns via Model Context Protocol.',
        url: 'https://perfos.adkit.so',
      },
      {
        '@type': 'Organization',
        ...
        sameAs: ['https://twitter.com/adkit_so', 'https://github.com/adkit'],
      },
    ],
  };
