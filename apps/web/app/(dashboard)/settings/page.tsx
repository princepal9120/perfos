...
export default function SettingsPage() {
  ...
  const [campaignAccessLevel, setCampaignAccessLevel] =
    useState<string>('Draft + Publish');
  const [isAccessModalOpen, setIsAccessModalOpen] = useState<boolean>(false);
  const [advancedPlatformAccess, setAdvancedPlatformAccess] =
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-0.5">
            Configure agent safety policies, workspace keys, and platform
            synchronization.
          </p>
        </div>
        {saveToast && (
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  Control what autonomous AI agents can execute, stage, or
              ...
              <div className="rounded-2xl border border-border bg-surface p-6 space-y-4 shadow-xl shadow-black/40">
                <div>
                  ...
                  <p className="mt-0.5 text-xs text-muted-foreground">
                    Agents and MCP tool calls without custom scope inherit this
                    policy setting.
                  </p>
                </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 rounded-xl border border-border bg-card p-4">
                  <div className="max-w-xl">
                    ...
                    <p className="mt-1 text-[11px] leading-relaxed text-muted-foreground">
                      Can formulate hooks, synthesize scripts, and stage drafts.
                      High-risk budget changes require human sign-off.
                    </p>
                  </div>
              ...
              <div className="rounded-2xl border border-border bg-surface p-6 space-y-4 shadow-xl shadow-black/40">
                <div>
                  ...
                  <p className="mt-0.5 text-xs text-muted-foreground">
                    Configure which connected marketing API capabilities agents
                    can invoke.
                  </p>
                </div>
                ...
                <div className="flex items-center justify-between gap-4 rounded-xl border border-border bg-card p-4">
                  <div className="max-w-xl">
                    <h4 className="text-xs font-semibold text-foreground">
                      Advanced MCP Tool Runner
                    </h4>
                    <p className="mt-1 text-[11px] leading-relaxed text-muted-foreground">
                      Permit agents to invoke platform tool schemas directly
                      (Meta AdSets, Google RSA, Shopify Orders). Changes remain
                    ...
                    {[
                      {
                        id: 'meta',
                        name: 'Meta Ads',
                        desc: 'Dynamic Creatives, Placement Media, Ad Sets',
                        active: platformToggles.meta,
                      },
                      {
                        id: 'google',
                        name: 'Google Ads',
                        desc: 'PMax Asset Groups, Search RSA, Video Ads',
                        active: platformToggles.google,
                      },
                      {
                        id: 'tiktok',
                        name: 'TikTok Ads',
                        desc: 'Spark Ads, Smart+, Video Hooks',
                        active: platformToggles.tiktok,
                      },
                      {
                        id: 'linkedin',
                        name: 'LinkedIn Ads',
                        desc: 'Sponsored Content, B2B Audience Split',
                        active: platformToggles.linkedin,
                      },
                    ].map((plat) => (
                      <div
                        key={plat.id}
                        ...
                        <button
                          ...
                          onClick={() => {
                            setPlatformToggles((prev) => ({
                              ...prev,
                              [plat.id]:
                                !prev[plat.id as keyof typeof platformToggles],
                            }));
                          ...
                          className={cn(
                            ...
                            platformToggles[
                              plat.id as keyof typeof platformToggles
                            ]
                              ? 'bg-primary'
                              : 'bg-zinc-800',
                          )}
          ...
          {activeTab === 'profile' && (
            <div className="space-y-6">
              <div>
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  Manage your personal operator account and security.
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-border bg-surface p-6 space-y-4 shadow-xl">
                <div className="flex items-center gap-4 border-b border-border pb-4">
                  ...
                  <div>
                    ...
                    <Badge
                      variant="outline"
                      className="mt-1 border-primary/30 bg-primary/10 text-[10px] text-primary"
                    >
                      Workspace Owner
                    </Badge>
                  </div>
          ...
          {activeTab === 'billing' && (
            <div className="space-y-6">
              <div>
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  Manage subscriptions, platform spend limits, and invoices.
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-border bg-surface p-6 space-y-4 shadow-xl">
                <div className="flex items-center justify-between border-b border-border pb-4">
                  <div>
                    <Badge
                      variant="outline"
                      className="border-primary/30 bg-primary/10 text-xs text-primary font-semibold"
                    >
                      PerfOS Pro Tier
                    </Badge>
                    <p className="mt-1 text-xs text-zinc-300">
                      $299 / month · Unlimited connected channels
                    </p>
                  </div>
                  <Button
                    variant="outline"
          ...
          {activeTab === 'devices_keys' && (
            <div className="space-y-6">
              <div>
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  Manage programmatic API keys and MCP authentication tokens.
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-border bg-surface p-6 space-y-4 shadow-xl">
                <div className="flex items-center justify-between border-b border-border pb-3">
                  <div>
                    <h4 className="text-xs font-semibold text-foreground">
                      Active MCP Session Token
                    </h4>
                    <p className="text-[11px] text-muted-foreground">
                      30-day persistent session for Codex CLI & Claude Desktop
                    </p>
                  </div>
                  <Badge
                    variant="outline"
          ...
          {activeTab === 'general' && (
            <div className="space-y-6">
              <div>
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  Global workspace defaults and brand parameters.
                </p>
              </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="mt-1 text-xs text-muted-foreground">
                    Control who can create, review drafts, and publish
                    campaigns.
                  </p>
                </div>
                <Button
              ...
              <div className="rounded-2xl border border-border bg-surface p-6 space-y-3 shadow-xl">
                {[
                  {
                    name: 'prince',
                    email: 'pal265354@gmail.com',
                    role: 'Owner',
                  },
                  {
                    name: 'PerfOS Autonomous Fleet',
                    email: 'agents@perfos.ai',
                    role: 'Draft + Publish',
                  },
                  {
                    name: 'Creative Producer',
                    email: 'creative@dtcbrand.co',
                    role: 'Editor',
                  },
                ].map((m) => (
                  <div
          ...
          {activeTab === 'ad_accounts' && (
            <div className="space-y-6">
              <div>
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  Manage ad networks and synchronization frequency.
                </p>
              </div>
          ...
          {activeTab === 'details' && (
            <div className="space-y-6">
              <div>
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  Project metadata and daily safety limits.
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-border bg-surface p-6 space-y-4 shadow-xl text-xs">
                ...
                <div className="pt-2 flex justify-end">
                  <Button
                    onClick={() => showToast('Project details saved')}
                    className="btn-daisy-solid text-xs"
                  >
                    Save Details
                  </Button>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-lg overflow-hidden rounded-2xl border border-border bg-surface p-6 shadow-2xl animate-in fade-in zoom-in-95">
            <h3 className="font-display text-base font-semibold text-foreground">
              Change Campaign Access Policy
            </h3>
            <p className="mt-1 text-xs text-muted-foreground">
              Select what level of authority AI agents hold when managing ad
              drafts.
            </p>
              ...
              {[
                {
                  id: 'Read-Only',
                  title: 'Read-Only',
                  desc: 'Agents can only inspect metrics and winning creatives. No drafts or publishing.',
                },
                {
                  id: 'Drafts Only',
                  title: 'Drafts Only',
                  desc: 'Agents can stage campaign variations as drafts. Every change requires human sign-off.',
                },
                {
                  id: 'Draft + Publish',
                  title: 'Draft + Publish (Recommended)',
                  desc: 'Can create drafts and automatically publish verified optimizations & budget shifts.',
                },
                {
                  id: 'Full Autonomous',
                  title: 'Full Autonomous',
                  desc: 'Autonomous budget scaling, daily asset swapping, and creative kill-switch rules.',
                },
              ].map((lvl) => (
                <div
                  key={lvl.id}
