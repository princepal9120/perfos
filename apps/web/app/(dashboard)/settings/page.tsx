  ...
  return (
    <div className="min-h-full pb-16">
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        {saveToast && (
          <div className="rounded-lg border border-primary/30 bg-purple-950/80 px-3 py-1.5 text-xs text-primary shadow-lg shadow-purple-950/50 animate-in fade-in">
            {saveToast}
          </div>
        )}
      </div>
        ...
        <div className="lg:col-span-9 space-y-6">
          ...
          {activeTab === "agent_permissions" && (
            <div className="space-y-6">
              {/* Top Title & Subtitle */}
              <div>
                <h2 className="font-display text-2xl font-bold tracking-tight text-foreground dark:text-white">
                  Agent Permissions
                </h2>
              ...
              <div className="rounded-2xl border border-border bg-card p-6 space-y-4 shadow-xl shadow-black/40">
                <div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 rounded-xl border border-border bg-muted p-4">
                  <div className="max-w-xl">
                    <h4 className="text-xs font-semibold text-foreground dark:text-white">Campaign access</h4>
                  ...
                  <div className="flex items-center gap-2.5 shrink-0">
                    ...
                    <span className="inline-flex items-center rounded-lg border border-purple-500/20 bg-[#25143e] px-2.5 py-1 text-[11px] font-semibold text-primary">
                      {campaignAccessLevel}
                    </span>
                    ...
                    <Button
                      ...
                      className="h-8 rounded-lg border border-border bg-muted hover:bg-muted text-xs font-medium text-foreground"
                    >
                      Change access
                    </Button>
                  </div>
              ...
              <div className="rounded-2xl border border-border bg-card p-6 space-y-4 shadow-xl shadow-black/40">
                ...
                <div className="flex items-center justify-between gap-4 rounded-xl border border-border bg-muted p-4">
                  <div className="max-w-xl">
                    <h4 className="text-xs font-semibold text-foreground dark:text-white">Advanced Platform Access</h4>
                    <p className="mt-1 text-[11px] leading-relaxed text-muted-foreground">
                ...
                <div className="pt-2">
                  <p className="text-[11px] font-semibold text-muted-foreground mb-2">Connected Platform Scopes</p>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                    {[
                      ...
                      <div
                        key={plat.id}
                        className="flex items-center justify-between rounded-xl border border-white/4 bg-card p-3"
                      >
                        <div>
                          <span className="text-xs font-semibold text-foreground dark:text-white">{plat.name}</span>
          ...
          {activeTab === "profile" && (
            <div className="space-y-6">
              <div>
                <h2 className="font-display text-2xl font-bold tracking-tight text-foreground dark:text-white">Profile Settings</h2>
              ...
              <div className="rounded-2xl border border-border bg-card p-6 space-y-4 shadow-xl">
                <div className="flex items-center gap-4 border-b border-border pb-4">
                  <div className="flex h-16 w-16 items-center justify-center rounded-full bg-purple-900/60 border border-purple-500/40 text-primary text-xl font-bold">
                    P
                  </div>
                  <div>
                    <h3 className="text-sm font-semibold text-foreground dark:text-white">prince</h3>
                    <p className="text-xs text-muted-foreground">pal265354@gmail.com</p>
                    <Badge variant="outline" className="mt-1 border-primary/30 bg-purple-500/10 text-[10px] text-primary">
                      Workspace Owner
                    </Badge>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                  <div>
                    ...
                    <input
                      type="text"
                      defaultValue="prince"
                      className="w-full rounded-lg border border-border bg-muted px-3 py-2 text-foreground dark:text-white outline-none focus:border-purple-500"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      disabled
                      className="w-full rounded-lg border border-white/5 bg-card px-3 py-2 text-muted-foreground outline-none"
                    />
                  </div>
                </div>

                <div className="pt-2 flex justify-end">
                  <Button onClick={() => showToast("Profile settings saved")} className="bg-primary hover:bg-primary text-white dark:text-white text-xs">
                    Save Changes
                  </Button>
                </div>
              </div>
          ...
          {activeTab === "billing" && (
            <div className="space-y-6">
              <div>
                <h2 className="font-display text-2xl font-bold tracking-tight text-foreground dark:text-white">Billing & Plan</h2>
              ...
              <div className="rounded-2xl border border-border bg-card p-6 space-y-4 shadow-xl">
                <div className="flex items-center justify-between border-b border-border pb-4">
                  <div>
                    <Badge variant="outline" className="border-primary/30 bg-purple-500/10 text-xs text-primary font-semibold">
                      PerfOS Pro Tier
                    </Badge>
                ...
                <div className="space-y-2 text-xs">
                  <div className="flex justify-between py-1 border-b border-white/4">
                    ...
                    <span className="text-foreground dark:text-white font-mono">Visa ending in 4242</span>
                  </div>
                  <div className="flex justify-between py-1 border-b border-white/4">
                    <span className="text-muted-foreground">Next Billing Date</span>
                    <span className="text-foreground dark:text-white">September 1, 2026</span>
                  </div>
          ...
          {activeTab === "devices_keys" && (
            <div className="space-y-6">
              <div>
                <h2 className="font-display text-2xl font-bold tracking-tight text-foreground dark:text-white">Devices & API Keys</h2>
              ...
              <div className="rounded-2xl border border-border bg-card p-6 space-y-4 shadow-xl">
                <div className="flex items-center justify-between border-b border-border pb-3">
                  <div>
                    <h4 className="text-xs font-semibold text-foreground dark:text-white">Active MCP Session Token</h4>
                ...
                <div className="flex items-center gap-2 rounded-xl bg-muted p-3 border border-white/5">
          ...
          {activeTab === "general" && (
            <div className="space-y-6">
              <div>
                <h2 className="font-display text-2xl font-bold tracking-tight text-foreground dark:text-white">General Workspace</h2>
              ...
              <div className="rounded-2xl border border-border bg-card p-6 space-y-4 shadow-xl">
                ...
                <div className="pt-2 flex justify-end">
                  <Button onClick={() => showToast("Workspace settings saved")} className="bg-primary hover:bg-primary text-white dark:text-white text-xs">
                    Save
                  </Button>
                </div>
              </div>
          ...
          {activeTab === "members" && (
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="font-display text-2xl font-bold tracking-tight text-foreground dark:text-white">Members & Roles</h2>
                  <p className="mt-1 text-xs text-muted-foreground">Control who can create, review drafts, and publish campaigns.</p>
                </div>
                <Button onClick={() => showToast("Invite link copied to clipboard")} size="sm" className="bg-primary hover:bg-primary text-white dark:text-white text-xs">
                  + Invite Member
                </Button>
              </div>

              <div className="rounded-2xl border border-border bg-card p-6 space-y-3 shadow-xl">
                {[
                  ...
                  <div key={m.email} className="flex items-center justify-between border-b border-white/4 pb-3 last:border-none">
                    <div>
                      <p className="text-xs font-semibold text-foreground dark:text-white">{m.name}</p>
                      <p className="text-[11px] text-muted-foreground">{m.email}</p>
                    </div>
                    <Badge variant="outline" className="border-purple-500/20 bg-purple-950/40 text-primary text-[10px]">
                      {m.role}
                    </Badge>
                  </div>
                ))}
          ...
          {activeTab === "ad_accounts" && (
            <div className="space-y-6">
              <div>
                <h2 className="font-display text-2xl font-bold tracking-tight text-foreground dark:text-white">Connected Ad Accounts</h2>
                <p className="mt-1 text-xs text-muted-foreground">Manage ad networks and synchronization frequency.</p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {[
                  ...
                  <div key={acc.id} className="rounded-xl border border-border bg-card p-4 space-y-2">
                    <div className="flex items-center justify-between">
                      <h4 className="text-xs font-semibold text-foreground dark:text-white">{acc.name}</h4>
          ...
          {activeTab === "details" && (
            <div className="space-y-6">
              <div>
                <h2 className="font-display text-2xl font-bold tracking-tight text-foreground dark:text-white">Project Details</h2>
                <p className="mt-1 text-xs text-muted-foreground">Project metadata and daily safety limits.</p>
              </div>

              <div className="rounded-2xl border border-border bg-card p-6 space-y-4 shadow-xl text-xs">
                <div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <input
                      ...
                      className="rounded-lg border border-border bg-muted px-3 py-2 text-foreground dark:text-white outline-none"
                    />
                    <input
                      type="text"
                ...
                <div className="pt-2 flex justify-end">
                  <Button onClick={() => showToast("Project details saved")} className="bg-primary hover:bg-primary text-white dark:text-white text-xs">
                    Save Details
                  </Button>
                </div>
              </div>
      ...
      {isAccessModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-lg overflow-hidden rounded-2xl border border-border bg-card p-6 shadow-2xl animate-in fade-in zoom-in-95">
            <h3 className="font-display text-base font-semibold text-foreground dark:text-white">Change Campaign Access Policy</h3>
            ...
            <div className="my-4 space-y-2.5">
              {[
                ...
                >
                  ...
                  <div>
                    <h4 className="text-xs font-semibold text-foreground dark:text-white">{lvl.title}</h4>
